...
internal static class OfficeOperationRegistry
{
    ...
    public static IReadOnlyDictionary<string, OfficeOperationSpec> Build()
    {
        var specs = new List<OfficeOperationSpec>
        {
            ...
            new("word_add_table_row", OfficeDocumentType.Word, true),
            new("word_delete_table_row", OfficeDocumentType.Word, true),
            new("word_add_table_column", OfficeDocumentType.Word, true),
            new("word_delete_table_column", OfficeDocumentType.Word, true),
            new("word_merge_table_cells", OfficeDocumentType.Word, true),
            new("word_delete_paragraph", OfficeDocumentType.Word, true),
            new("word_delete_style", OfficeDocumentType.Word, true),
            new("word_update_style", OfficeDocumentType.Word, true),
            new("word_append_markdown", OfficeDocumentType.Word, true),
            new("word_validate_document", OfficeDocumentType.Word, false),
            ...
            new("word_get_paragraph_info", OfficeDocumentType.Word, false),
            ...
            new("excel_get_cell_style", OfficeDocumentType.Excel, false),
            ...
            new("powerpoint_get_text_style", OfficeDocumentType.PowerPoint, false, "power_point_get_text_style"),
